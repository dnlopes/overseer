...
func DarkTheme() Theme {
	return Theme{
		...
		StatusRunningFg: lipgloss.Color("#10B981"),
		StatusRunningBg: lipgloss.Color("#0A2E22"),
		StatusWaitingFg: lipgloss.Color("#F59E0B"),
		StatusWaitingBg: lipgloss.Color("#3A2A0E"),
		StatusIdleFg:    lipgloss.Color("#6B7280"),
		StatusDeadFg:    lipgloss.Color("#EF4444"),
		StatusDeadBg:    lipgloss.Color("#3A1414"),
		StatusUnknownFg: lipgloss.Color("#9CA3AF"),
	}
}
